 ...
 * Ein Layer hat somit einen mehr Dimensionalen Eingang, der bei allen Neuronen hinein geschrieben wird, und einen mehrdimensionalen Ausgang, wobei ein Neuron jeweils einer Dimension entspricht.
 *
 */
public class Layer {
    ...
    /**
     * Erzeugt einen Layer und befüllt ihn mit Sigmiod Neuronen
     ...
     */
	public double[] feedForward(double[] input, boolean isStartLayer){
